...
public class CartController {
    ...
    public ResponseEntity<CartResponse> addProductToCart(@RequestBody CartUpdateRequest cartUpdateRequest){
        return new ResponseEntity<>(cartService.addProductToCart(cartUpdateRequest),HttpStatus.OK);
    }
    @PutMapping("/removeProductFromCart")
    public ResponseEntity<CartResponse> removeProductFromCart(@RequestBody CartUpdateRequest cartUpdateRequest){
